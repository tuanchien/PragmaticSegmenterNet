...
{
    protected static IReadOnlyList<string> Empty = [];

    protected static readonly IReadOnlyList<string> SentenceStartersCore =
    [
        "A",
        "Being",
        "Did",
    ...
    protected static readonly IReadOnlyList<string> PunctuationsCore =
    [
        "\u3002", "\uff0e", ".", "\uff01", "!", "?", "\uff1f"
    ];
