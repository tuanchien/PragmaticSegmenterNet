...
internal sealed class JapaneseLanguage : LanguageBase
{
    ...
    private sealed class JapaneseBetweenPunctuationReplacer : BetweenPunctuationReplacer
    {
    ...
    private sealed class JapaneseCleanerBehaviour : CleanerBehaviourBase
    {
